...
import be.noki_senpai.NKcore.api.data.packet.ErrorResponse;
import be.noki_senpai.NKcore.api.data.packet.PlayersQueryResponse;
import be.noki_senpai.NKcore.api.data.packet.ReceivedData;
import be.noki_senpai.NKcore.api.data.packet.ServersQueryResponse;
